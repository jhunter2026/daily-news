...
// owner can see what the AI passed on too (not just what cleared the bar).
// Same recency window as the curated view, no score gate, no urgency blend --
// the dashboard's whole point is seeing the raw scores themselves, so it
// doesn't pre-judge with a composite ranking.
