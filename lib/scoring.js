...
//
// This must stay small relative to callers' own TIME_BUDGET_MS/
// SCORING_DEADLINE_MS: that check only runs *between* items, so two
// consecutive maxed-out calls alone (2 * GEMINI_TIMEOUT_MS) must not exceed
// the caller's deadline, or a hang on item 2 (started because item 1's
// timeout alone hadn't yet crossed the deadline) can still blow the 10s wall.
